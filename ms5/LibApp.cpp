...
//            if (matches)
//            {
//                // Add matching publication to selector
//                ps << m_publication[i];
//            }
//        }
//    }
...
//        {
//            cout << "Adding new publication to the library" << endl;
//            cout << "Current number of publications: " << m_numpub << endl;  // Debugging info
//            cout << "Library capacity: " << SENECA_LIBRARY_CAPACITY << endl;  // Debugging info
//
//            // Get the type of publication to add
